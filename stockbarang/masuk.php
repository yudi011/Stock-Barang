                                    ...
                                    <?php
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="number" name="faktur" value="<?=$faktur;?>" class="form-control" required><br>
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Datang Barang</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <div class="modal-body">
        ...
        <input type="number" name="faktur" placeholder="Faktur Barang" class="form-control" required><br>
