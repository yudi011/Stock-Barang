                        ...
                        <div class="nav">
                            ...
                            <a class="nav-link" href="keluar.php">
                             ...
                             <a class="nav-link" href="permintaan.php">
                                ...
                                <a class="nav-link" href="monitoring_ping.php">
    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
    Monitoring Ping
                            </a>
                                        ...
                                        <tr>
                                         ...
                                         <!-- Edit Modal
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <form method="post">
                                                <div class="modal-body">   
                                                Apakah Anda yakin ingin menghapus <?=$namabarang;?>?<br>
                                                    <input type="text" name="namabarang" value="<?=$namabarang;?>" class="form-control" required><br>
                                                    <input type="text" name="deskripsi" value="<?=$deskripsi;?>" class="form-control" required><br>
                                                    <input type="hidden" name="<?=$idb;?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">   
        ...
        <select type="option" name="deskripsi" placeholder="Keterangan Barang" class="form-control" required>
                    <option value="-" required>- Satuan -
                    <option value="Unit">Unit
                    <option value="Pcs">Pcs
                    <option value="Pack">Pack
                    <option value="Roll">Roll
                    <option value="Dus">Dus
        </select><br>
