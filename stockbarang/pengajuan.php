...
<html lang="en">
    <head>
        ...
        <title>Pengajuan Pemasangan Kamera</title>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $ambilpermintaan = mysqli_query($conn,"select * from pengajuan");
                                        $i = 1;
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Pengajuan Pemasangan</h4>
      ...
      <div class="modal-body">
        ...
        <input type="text" name="tempat" placeholder="Tempat Pemasangan" class="form-control" required><br>
        <input type="texy" name="lokasi" placeholder="Lokasi Pemasangan" class="form-control" required><br>
        <input type="number" name="unit" placeholder="QTY Barang" class="form-control" required><br>
        <select type="option" name="sts" class="form-control" required><br>
                    <option value="Prosess">Prosess
                    <option value="Done">Done
                                    </select><br>
